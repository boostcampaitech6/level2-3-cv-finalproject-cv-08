...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='./SimSwap/checkpoints', help='models are saved here')
        ...
        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='./SimSwap/datasets/cityscapes/') 
